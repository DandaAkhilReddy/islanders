...
export const metadata = {
  title: "Top 5 Players - Islanders Cricket Club",
  description:
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
              Our elite performers leading the team with exceptional statistics from the 2025 season.
              Comprehensive breakdown of batting, bowling, and fielding excellence.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-lg bg-emerald-50 p-6 text-center">
              <p className="text-5xl font-bold text-emerald-600">
                {top5Players.reduce((sum, p) => sum + p.totalStats.runs, 0)}
              </p>
            ...
            <div className="rounded-lg bg-emerald-50 p-6 text-center">
              <p className="text-5xl font-bold text-emerald-600">
                {top5Players.reduce((sum, p) => sum + (p.totalStats.wickets || 0), 0)}
              </p>
              <p className="mt-2 text-sm font-semibold uppercase tracking-wider text-gray-600">
                Total Wickets
              </p>
            ...
            <div className="rounded-lg bg-emerald-50 p-6 text-center">
              <p className="text-5xl font-bold text-emerald-600">
                {top5Players.reduce((sum, p) => sum + (p.totalStats.catches || 0), 0)}
              </p>
              <p className="mt-2 text-sm font-semibold uppercase tracking-wider text-gray-600">
                Total Catches
              </p>
            ...
            <div className="rounded-lg bg-emerald-50 p-6 text-center">
              <p className="text-5xl font-bold text-emerald-600">
                {(
                  top5Players.reduce((sum, p) => sum + p.totalStats.average, 0) /
                  top5Players.length
                ).toFixed(2)}
              </p>
              <p className="mt-2 text-sm font-semibold uppercase tracking-wider text-gray-600">
